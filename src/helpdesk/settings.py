...
HELPDESK_DUPLICATE_DETECTION_ENABLED = getattr(
    settings, "HELPDESK_DUPLICATE_DETECTION_ENABLED", True
)

HELPDESK_DUPLICATE_TITLE_SIMILARITY_THRESHOLD = getattr(
    settings, "HELPDESK_DUPLICATE_TITLE_SIMILARITY_THRESHOLD", 0.7
)

HELPDESK_DUPLICATE_DESCRIPTION_SIMILARITY_THRESHOLD = getattr(
    settings, "HELPDESK_DUPLICATE_DESCRIPTION_SIMILARITY_THRESHOLD", 0.5
)

HELPDESK_DUPLICATE_TIME_WINDOW_DAYS = getattr(
    settings, "HELPDESK_DUPLICATE_TIME_WINDOW_DAYS", 30
)

HELPDESK_DUPLICATE_MATCH_SUBMITTER_EMAIL = getattr(
    settings, "HELPDESK_DUPLICATE_MATCH_SUBMITTER_EMAIL", True
)

HELPDESK_DUPLICATE_SAME_QUEUE_ONLY = getattr(
    settings, "HELPDESK_DUPLICATE_SAME_QUEUE_ONLY", True
)

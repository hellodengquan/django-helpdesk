...
# List of status choices to exclude from escalation
DEFAULT_TICKET_ESCALATION_EXCLUDE_STATUSES = ()
TICKET_ESCALATION_EXCLUDE_STATUSES = getattr(
    settings, "HELPDESK_TICKET_ESCALATION_EXCLUDE_STATUSES", DEFAULT_TICKET_ESCALATION_EXCLUDE_STATUSES
)
